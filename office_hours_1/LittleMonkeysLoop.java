...
public class LittleMonkeysLoop {
	/**
    Create a class and name it LittleMonkeysWithForLoop
	write a program that prints 5 Little Monkeys jumping on the bed with loop
    */
